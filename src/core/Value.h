...
/// Per-atom-weighted projection of two CV gradients:
/// Σ_a w_a (∇v1)_a · (∇v2)_a, with w_a indexed by AtomNumber::index().
/// Used by the ASM action to assemble its CV-space metric tensor.
  static double projectionWithAtomWeights(const Value& v1, const Value& v2,
